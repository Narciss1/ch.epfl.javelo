...
public final class Ch1903 {
    ...
    public static double e(double lon, double lat){
        //double lon1 = Math.pow(10.0, -4.0)*(3600.0*Math.toDegrees(lon) - 26782.5);
        //double lat1 = Math.pow(10.0, -4.0)*(3600.0*Math.toDegrees(lat) - 169028.66);
    ...
    public static double lon(double e, double n){
        //double x = Math.pow(10.0, -6)*(e - 2600000.0);
        //double y = Math.pow(10.0, -6)*(n - 1200000.0);
    ...
    public static double lat(double e, double n){
        //double x = Math.pow(10.0, -6.0)*(e - 2600000.0);
        //double y = Math.pow(10.0, -6.0)*(n - 1200000.0);
        double x = 0.000001*(e - 2600000.0);
        double y = 0.000001*(n - 1200000.0);
