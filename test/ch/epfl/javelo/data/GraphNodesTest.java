...
public class GraphNodesTest {
    ...
    void methodsGraphSectorsWorksAyaTest() {
        ...
        assertEquals(2, ns.outDegree(0));
        //assertEquals(0x918_1234, ns.edgeId(0, 0));
        //assertEquals(0x918_1235, ns.edgeId(0, 1));
        ...
        //assertEquals(0x803_0926, ns.edgeId(1, 1));
    }
    ...
    void methodsGraphSectorsWorksAyaTest2() {
        ...
        //assertEquals(0x929_1029, ns.edgeId(0, 0));
        //assertEquals(0x929_1030, ns.edgeId(0, 1));
        ...
        //assertEquals(0x800_0016, ns.edgeId(1, 1));
        ...
        //assertEquals(0x800_0011, ns.edgeId(2, 1));
    }
}